...
import (
	...
	"github.com/VG-Tech-Dojo/vg-1day-2017-06-11/ryoma/bot"
	"github.com/VG-Tech-Dojo/vg-1day-2017-06-11/ryoma/controller"
	"github.com/VG-Tech-Dojo/vg-1day-2017-06-11/ryoma/db"
	"github.com/VG-Tech-Dojo/vg-1day-2017-06-11/ryoma/model"
...
func (s *Server) Init(dbconf, env string) error {
	...
	s.Engine.GET("/ryoma", func(c *gin.Context) {
		c.HTML(http.StatusOK, "ryoma.html", gin.H{})
	})
