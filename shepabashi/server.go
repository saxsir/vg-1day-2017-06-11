...
import (
	...
	"github.com/VG-Tech-Dojo/vg-1day-2017-06-11/shepabashi/bot"
	"github.com/VG-Tech-Dojo/vg-1day-2017-06-11/shepabashi/controller"
	"github.com/VG-Tech-Dojo/vg-1day-2017-06-11/shepabashi/db"
	"github.com/VG-Tech-Dojo/vg-1day-2017-06-11/shepabashi/model"
...
func (s *Server) Init(dbconf, env string) error {
	...
	// tutorial. 自己紹介を追加する
	s.Engine.GET("/shepabashi", func(c *gin.Context) {
		c.HTML(http.StatusOK, "shepabashi.html", gin.H{})
	})
