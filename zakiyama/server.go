...
import (
	...
	"github.com/VG-Tech-Dojo/vg-1day-2017-06-11/zakiyama/bot"
	"github.com/VG-Tech-Dojo/vg-1day-2017-06-11/zakiyama/controller"
	"github.com/VG-Tech-Dojo/vg-1day-2017-06-11/zakiyama/db"
	"github.com/VG-Tech-Dojo/vg-1day-2017-06-11/zakiyama/model"
...
func (s *Server) Init(dbconf, env string) error {
	...
	s.Engine.GET("/zakiyama", func(c *gin.Context) {
		c.HTML(http.StatusOK, "zakiyama.html", gin.H{})
	})
