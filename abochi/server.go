...
import (
	...
	"github.com/VG-Tech-Dojo/vg-1day-2017-06-11/abochi/bot"
	"github.com/VG-Tech-Dojo/vg-1day-2017-06-11/abochi/controller"
	"github.com/VG-Tech-Dojo/vg-1day-2017-06-11/abochi/db"
	"github.com/VG-Tech-Dojo/vg-1day-2017-06-11/abochi/model"
...
func (s *Server) Init(dbconf, env string) error {
	...
	s.Engine.GET("/abochi", func(c *gin.Context) {
        	c.HTML(http.StatusOK, "abochi.html", gin.H{})
	})
