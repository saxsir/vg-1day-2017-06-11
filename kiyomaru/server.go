...
import (
	...
	"github.com/VG-Tech-Dojo/vg-1day-2017-06-11/kiyomaru/bot"
	"github.com/VG-Tech-Dojo/vg-1day-2017-06-11/kiyomaru/controller"
	"github.com/VG-Tech-Dojo/vg-1day-2017-06-11/kiyomaru/db"
	"github.com/VG-Tech-Dojo/vg-1day-2017-06-11/kiyomaru/model"
...
func (s *Server) Init(dbconf, env string) error {
	...
	// tutorial. 自己紹介を追加する
	s.Engine.GET("/kiyomaru", func(c *gin.Context) {
		c.HTML(http.StatusOK, "kiyomaru.html", gin.H{})
	})
