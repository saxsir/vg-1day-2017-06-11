...
import (
	...
	"github.com/VG-Tech-Dojo/vg-1day-2017-06-11/makishi/bot"
	"github.com/VG-Tech-Dojo/vg-1day-2017-06-11/makishi/controller"
	"github.com/VG-Tech-Dojo/vg-1day-2017-06-11/makishi/db"
	"github.com/VG-Tech-Dojo/vg-1day-2017-06-11/makishi/model"
...
func (s *Server) Init(dbconf, env string) error {
	...
	s.Engine.GET("/makishi", func(c *gin.Context) {
		c.HTML(http.StatusOK, "makishi.html", gin.H{})
	})
