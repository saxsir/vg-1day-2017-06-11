...
import (
	...
	"github.com/VG-Tech-Dojo/vg-1day-2017-06-11/mirurin/bot"
	"github.com/VG-Tech-Dojo/vg-1day-2017-06-11/mirurin/controller"
	"github.com/VG-Tech-Dojo/vg-1day-2017-06-11/mirurin/db"
	"github.com/VG-Tech-Dojo/vg-1day-2017-06-11/mirurin/model"
...
func (s *Server) Init(dbconf, env string) error {
	...
	s.Engine.GET("/mirurin", func(c *gin.Context) {
		c.HTML(http.StatusOK, "mirurin.html", gin.H{})
	})
