...
import (
	...
	"github.com/VG-Tech-Dojo/vg-1day-2017-06-11/genya0407/bot"
	"github.com/VG-Tech-Dojo/vg-1day-2017-06-11/genya0407/controller"
	"github.com/VG-Tech-Dojo/vg-1day-2017-06-11/genya0407/db"
	"github.com/VG-Tech-Dojo/vg-1day-2017-06-11/genya0407/model"
...
func (s *Server) Init(dbconf, env string) error {
	...
	s.Engine.GET("/genya0407", func(c *gin.Context) {
		c.HTML(http.StatusOK, "genya0407.html", gin.H{})
	})
