...
import (
	...
	"github.com/VG-Tech-Dojo/vg-1day-2017-06-11/kinokoruumu/bot"
	"github.com/VG-Tech-Dojo/vg-1day-2017-06-11/kinokoruumu/controller"
	"github.com/VG-Tech-Dojo/vg-1day-2017-06-11/kinokoruumu/db"
	"github.com/VG-Tech-Dojo/vg-1day-2017-06-11/kinokoruumu/model"
...
func (s *Server) Init(dbconf, env string) error {
	...
	s.Engine.GET("/kinokoruumu", func(c *gin.Context) {
		c.HTML(http.StatusOK, "kinokoruumu.html", gin.H{})
	})
