...
import (
	...
	"github.com/VG-Tech-Dojo/vg-1day-2017-06-11/arata/bot"
	"github.com/VG-Tech-Dojo/vg-1day-2017-06-11/arata/controller"
	"github.com/VG-Tech-Dojo/vg-1day-2017-06-11/arata/db"
	"github.com/VG-Tech-Dojo/vg-1day-2017-06-11/arata/model"
...
func (s *Server) Init(dbconf, env string) error {
	...
	s.Engine.GET("/arata", func(c *gin.Context) {
		c.HTML(http.StatusOK, "arata.html", gin.H{})
	})
